...
export const getSessions = (pid, courseCode) => dispatch => {
  ...
  axios
    .get(PublicURL + ":5001/nox/api/sessions/AllSessions", {
...
export const downloadSession = courseCode => dispatch => {
  ...
  axios
    .get(PublicURL + `:5001/nox/api/sessions/sesid`, {
      //this gets the sesid from Session schema
      params: {
    ...
    .then(res => {
      ...
      return axios
        .get(PublicURL + `:5001/nox/api/sessions/session.txt`, {
          params: {
        ...
        .then(res => {
          //this gets the session data from the Records schema
          dispatch({
